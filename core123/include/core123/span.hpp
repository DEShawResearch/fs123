...
// On Dec 12, 2019.  The commit is: 9d7559aabdebf569cab3480a7ea2a87948c0ae47
// 
// The accompanying readme says:
// <README>
// Usage
//
// The recommended way to use the implementation simply copy the file
// span.hpp from include/tcb/ into your own sources and #include it
// like any other header. By default, it lives in namespace tcb, but
// this can be customised by setting the macro TCB_SPAN_NAMESPACE_NAME
// to an appropriate string before #include-ing the header -- or
// simply edit the source code.
// 
// The rest of the repository contains testing machinery, and is not
// required for use.
// </README>
...
struct span_storage {
    ...
    // jks - change arg name to silence warnings
    constexpr span_storage(E* pptr, std::size_t /*unused*/) noexcept : ptr(pptr)
    {}
...
struct span_storage<E, dynamic_extent> {
    ...
    // jks - change arg name to silence warnings
    constexpr span_storage(E* pptr, std::size_t ssize) noexcept
        : ptr(pptr), size(ssize)
    {}
