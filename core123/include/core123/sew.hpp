...
_wrap_void(fsync);
_NOT_APPLE( _wrap_void(fdatasync); )
_wrap_void(pipe);
_wrap(dup);
_wrap(dup2);
_wrap_void(truncate);
...
_wrap_void(lchown);
_wrap(getxattr);
_NOT_APPLE( _wrap(lgetxattr); )
_wrap(fgetxattr);
_wrap(listxattr);
_NOT_APPLE( _wrap(llistxattr); )
_wrap(flistxattr);
_wrap_void(setxattr);
_NOT_APPLE( _wrap_void(lsetxattr); )
_wrap_void(fsetxattr);
_wrap_void(removexattr);
_NOT_APPLE( _wrap_void(lremovexattr); )
_wrap_void(fremovexattr);
_wrap_void(utime);
_wrap_void(utimes);
_wrap_void(futimes);
_NOT_APPLE( _wrap_void(futimesat); )

// functions in fcntl.h (fcntl is below)
_wrap(creat);
_NOT_APPLE( _wrap(creat64); )
_wrap_void(lockf);
_NOT_APPLE( _wrap_void(lockf64); )
_NOT_APPLE( _wrap_returns_errno(posix_fadvise); )
_NOT_APPLE( _wrap_returns_errno(posix_fadvise64); )
_NOT_APPLE( _wrap_returns_errno(posix_fallocate); )
_NOT_APPLE( _wrap_returns_errno(posix_fallocate64); )

// memory mapping
_wrapev(mmap,  MAP_FAILED);
_wrap_void(munmap);
_NOT_APPLE( _wrap_void(brk); ) // actually, it is on apple, but it throws an error
_NOT_APPLE( _wrapev(sbrk, (void*)-1); )
_wrap_void(madvise);
_wrap_void(mprotect);
_wrap_void(mincore);
_wrap_void(msync);
...
_wrap(getuid);
_wrap(geteuid);
_NOT_APPLE( _wrap_void(getresuid); )
_wrap_void(setuid);
_wrap_void(seteuid);
_NOT_APPLE( _wrap_void(setreuid); )
_NOT_APPLE( _wrap(setresuid); )
_wrap(getgid);
_wrap(getegid);
_NOT_APPLE( _wrap_void(getresgid); )
_wrap(setgid);
_wrap(setegid);
_wrap(setregid);
_NOT_APPLE( _wrap(setresgid); )
_wrap(getgroups);
...
_NOT_APPLE( _wrapev_check_errno1(readdir64, (dirent64*)0); )
...
_NOT_APPLE( _wrapspecial(void readdir64_r(::DIR* dirp, struct dirent64*entry, struct dirent64** result),
{
...
// file notification
_NOT_APPLE( _wrap(inotify_init); )
_NOT_APPLE( _wrap(inotify_add_watch); )
_NOT_APPLE( _wrap_void(inotify_rm_watch); )
...
_NOT_APPLE( _wrap(sigwaitinfo); )
_NOT_APPLE( _wrap(sigtimedwait); )
_NOT_APPLE( _wrap_void(sigqueue); )
...
_wrap(pselect);
_wrap(poll);
_NOT_APPLE( _wrap(ppoll); )
_NOT_APPLE( _wrap(epoll_create); )
_NOT_APPLE( _wrap(epoll_wait); )
_NOT_APPLE( _wrap_void(epoll_ctl); )
_wrap_void(send);
_wrap_void(sendto);
_wrap_void(sendmsg);
_wrap(sendfile);
...
_NOT_APPLE( _wrap_void_linkage(gethostbyname_r); )
_NOT_APPLE( _wrap_void_linkage(gethostbyname2_r); )
_NOT_APPLE( _wrap_void_linkage(gethostent_r); )
